...
/// The error when the event queue has been garbage collected
///
/// https://zulip.com/api/get-events#bad_event_queue_id-errors
ZulipApiException apiExceptionBadEventQueueId({String queueId = 'fb67bf8a-c031-47cc-84cf-ed80accacda8'}) {
