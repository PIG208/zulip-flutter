  ...
  group('EmojiPicker', () {
    ...
    group('handle view paddings', () {
      ...
      Future<void> prepare(WidgetTester tester, {
        ...
        check(scrollViewRect.bottom).equals(screenHeight);
        // There should always be enough entries to overflow the scroll view.
        check(getListEntriesRect(tester).height)
          .isGreaterThan(scrollViewRect.height);
      }
      ...
      testWidgets('no view padding', (tester) async {
        ...
        check(scrollViewRect.bottom).isLessThan(listEntriesRect.bottom);
        ...
        check(scrollViewRect.top).isGreaterThan(listEntriesRect.top);
        check(scrollViewRect.bottom).equals(listEntriesRect.bottom + 8);
      ...
      testWidgets('with bottom view padding', (tester) async {
        ...
        listEntriesRect = getListEntriesRect(tester);
        check(scrollViewRect.top).isGreaterThan(listEntriesRect.top);
        check(scrollViewRect.bottom).equals(listEntriesRect.bottom + 10);
